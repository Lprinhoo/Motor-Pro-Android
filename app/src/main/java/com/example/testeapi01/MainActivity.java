...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Verifica login via SharedPreferences (sem Firebase)
        ...
        btnServices.setOnClickListener(v -> {
            if (oficinaSelecionada != null) {
                ...
                if (oficinaSelecionada.getServicos() != null) {
                    intent.putStringArrayListExtra("OFICINA_SERVICOS",
                            new ArrayList<>(oficinaSelecionada.getServicos()));
                }
                if (oficinaSelecionada.getMecanicos() != null) {
                    intent.putStringArrayListExtra("OFICINA_MECANICOS",
                            new ArrayList<>(oficinaSelecionada.getMecanicos()));
                }
    ...
    private void mostrarOficinasNoMapa() {
        ...
        BitmapDescriptor icon = BitmapDescriptorFactory.fromBitmap(
                Bitmap.createScaledBitmap(b, 80, 80, false));
        ...
        for (Oficina oficina : listaOficinas) {
            ...
            if (marker != null) marker.setTag(oficina);
